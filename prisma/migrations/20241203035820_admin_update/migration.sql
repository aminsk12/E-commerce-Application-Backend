/*
  ...
  - The values [SUPER_ADMIN,CASTOMER] on the enum `UserRole` will be removed. If these variants are still used in the database, this will fail.
  ...
  - You are about to drop the column `needPasswerdChange` on the `users` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "users" DROP COLUMN "needPasswerdChange",
